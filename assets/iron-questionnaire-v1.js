...
const S=window.FORM_IRON_V1.state=window.FORM_IRON_V1.state||{
 ...
 strike:null,strikeConsistency:null,direction:null,trajectory:null,carryConsistency:null,turf:null,priorities:[],launchMonitorDetail:null
};
...
function mount(root){
 ...
 <h3>What does your current iron set look like?</h3><div class="choiceRow" data-field="currentSetMakeup"><button data-v="traditional">Mostly traditional irons</button><button data-v="combo">Combo set</button><button data-v="hybrid_heavy">Hybrids / utility clubs replace longer irons</button><button data-v="unsure">Not sure</button></div>
 <h3>Which best describes your current game?</h3><div class="choiceRow" data-field="ability"><button data-v="scratch_5">Scratch–5</button><button data-v="6_12">6–12</button><button data-v="13_20">13–20</button><button data-v="21_plus">21+</button><button data-v="unknown">I don’t keep a handicap</button></div>
 <h2>What do you know about your 7-iron?</h2>
 ...
 <h3>How repeatable is your strike location?</h3><div class="choiceRow" data-field="strikeConsistency"><button data-v="consistent">Usually in the same area</button><button data-v="mixed">Moves around the face</button><button data-v="unknown">Not sure</button></div>
 ...
 <h3>How consistent is your carry distance?</h3><div class="choiceRow" data-field="carryConsistency"><button data-v="consistent">Pretty consistent</button><button data-v="variable">Varies noticeably</button><button data-v="unknown">Not sure</button></div>
 <h3>What kind of divot do you usually take?</h3><div class="choiceRow" data-field="turf"><button data-v="shallow">Shallow / little turf</button><button data-v="medium">Medium</button><button data-v="deep">Deep</button><button data-v="mixed">It varies</button><button data-v="unknown">Not sure</button></div>
 <h3>Do you know your iron launch-monitor data?</h3><div class="choiceRow" data-field="launchMonitorDetail"><button data-v="range">Yes — I know my typical ranges</button><button data-v="general">I know my typical tendencies</button><button data-v="none">No — I don’t know my launch-monitor data</button></div>
 <p class="note">Detailed launch-monitor values are not yet used by this research ranking. This question uses the same range / tendency / none pattern as Driver, but the answer belongs to this iron fitting only.</p>
