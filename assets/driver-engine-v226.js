// FORM 8.226 — evidence-driven driver scorer with conservative hard-constraint upgrade semantics
(function(){
'use strict';
...
function needProfile(g){
  ...
  // Absolute FORM Fit is intentionally independent of current-club satisfaction and reported
  // current-equipment problems. Only golfer/delivery inputs may define the need profile here.
