...
(function(){
  'use strict';
  const neutral=document.createElement('link');neutral.rel='stylesheet';neutral.href='assets/neutral-options-v91.css?v=9.3';neutral.dataset.formNeutral='true';if(!document.querySelector('link[data-form-neutral]'))document.head.appendChild(neutral);
  ...
  function refreshPathCopy(){
    ...
    const copy={
      ...
      complete:{label:'FULL GOLFER',title:'Build my complete golf profile.',desc:'Everything in Full Bag, plus shoes, gloves, apparel and broader golfer preferences.',foot:'EQUIPMENT + THE REST OF YOUR GAME'}
    };
    ...
    const intro=document.querySelector('#page-fitstart .fitStartIntro p');if(intro)intro.textContent='Choose one category, fit your full bag, or build a complete golfer profile.';
  }
