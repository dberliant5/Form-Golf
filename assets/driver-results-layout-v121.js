...
function boot(){
  ...
  function apply(){
    ...
    cards.forEach((card,i)=>{const row=rows[i],box=card.querySelector('.report100Break');if(!row||!box)return;box.classList.add('report121Break');box.innerHTML=scorecard(row);});
