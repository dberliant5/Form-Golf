...
["Mizuno Pro M-13","players",148.8,165],
["Cobra 3DP MB","players",147.1,246],
["Ping i240","players",146.8,136.6],
...
["Callaway Quantum Max OS","super_gi",null,85.4],
["Callaway Quantum Max","super_gi",null,129.2],
["Cobra Baffler","super_gi",null,145.1],
["Cobra King Max","super_gi",null,172.7],
...
["Ping i540","players_distance",null,null],
...
].map(([model,category,carryYd,dispersion95SqFt])=>({model,category,carryYd,dispersion95SqFt,protocol:"GD_GL_2026_82MPH_36SHOT_6ZONE",direct:true}));
