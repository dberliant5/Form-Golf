...
// until the matrix's declared prerequisites are actually satisfied.
assert.equal(R.rankingAllowed,false);
assert.deepEqual(R.requiredBeforeRanking,["complete_model_identity","verified_common_fields","field_level_provenance","blind_archetype_tests"]);
